...
pub const PRODUCTS: &[(&str, &str, &str)] = &[
    ...
    (
        ...
        "OTC Medicines أدوية بدون روشتة",
    ),
    (
        "Pharco فاركو",
    ...
    (
        ...
        "Prescription Medicines أدوية روشتة",
    ),
    (
        "Amoun آمون",
    ...
    (
        "Eva Pharm إيفا فارم",
        "Calcium + Vitamin D كالسيوم + فيتامين د",
    ...
    (
        "Eva Pharm إيفا فارم",
        "Vitamin B-Complex فيتامين ب كومبلكس",
        "Supplements مكملات غذائية",
    ),
    (
        "Eva Pharm إيفا فارم",
    ...
    // Medical Devices
    (
        "Siemens Healthineers سيمنس هيلثينيرز",
        "Glucometer جهاز قياس السكر",
        "Medical Devices أجهزة طبية",
    ),
    (
        "Siemens Healthineers سيمنس هيلثينيرز",
        "Glucose Test Strips شرائط قياس السكر",
        "Medical Devices أجهزة طبية",
    ),
    (
        "Siemens Healthineers سيمنس هيلثينيرز",
        "Blood Pressure Monitor جهاز قياس الضغط",
        "Medical Devices أجهزة طبية",
    ),
    (
        "Siemens Healthineers سيمنس هيلثينيرز",
        "Digital Thermometer جهاز قياس الحرارة",
        "Medical Devices أجهزة طبية",
    ),
    (
        "Siemens Healthineers سيمنس هيلثينيرز",
    ...
    (
        "3M ثري إم",
        "First Aid Kit طقم الإسعاف الأولي",
        "Medical Devices أجهزة طبية",
    ),
    (
        "3M ثري إم",
        "Medical Masks أقنعة طبية",
        "Medical Devices أجهزة طبية",
    ),
    (
        "3M ثري إم",
        "Alcohol Swabs قطع كحول",
        "Medical Devices أجهزة طبية",
    ),
    (
        "3M ثري إم",
        "Surgical Tape شريط جراحي",
        "Medical Devices أجهزة طبية",
    ),
    (
        "3M ثري إم",
    ...
    (
        "Nivea نيفيا",
        "Moisturizing Cream كريم مرطب",
        "Cosmetics تجميل",
    ),
    (
        "Nivea نيفيا",
        "Face Wash غسول يومي للوجه",
        "Cosmetics تجميل",
    ),
    ...
    (
        "L'Oréal لوريال",
        "Anti-Aging Cream كريم مكافحة الشيخوخة",
        "Cosmetics تجميل",
    ),
    (
        "L'Oréal لوريال",
        "Hydrating Serum سيروم ترطيب",
        "Cosmetics تجميل",
    ),
    (
        "L'Oréal لوريال",
        "Hair Shampoo شامبو للشعر",
        "Cosmetics تجميل",
    ),
    (
        "L'Oréal لوريال",
    ...
    // Veterinary
    (
        "Memphis Pharm ممفيس فارم",
        "Enrofloxacin إنروفلوكساسين",
        "Veterinary طب بيطري",
    ),
    (
        "Memphis Pharm ممفيس فارم",
    ...
    (
        "Memphis Pharm ممفيس فارم",
        "Anti-Flea Spray بخاخ مضاد للبراغيث",
        "Veterinary طب بيطري",
    ),
    (
        "Memphis Pharm ممفيس فارم",
        "Pet Vitamin Syrup فيتامين حيوانات شراب",
        "Veterinary طب بيطري",
    ),
    (
        "Memphis Pharm ممفيس فارم",
        "Electrolyte Solution محلول إلكتروليت",
        "Veterinary طب بيطري",
    ),
    (
        "Memphis Pharm ممفيس فارم",
        "Wound Healing Spray بخاخ التئام الجروح",
        "Veterinary طب بيطري",
    ),
    (
        "Memphis Pharm ممفيس فارم",
        "Eye Drops for Animals قطرات عين للحيوانات",
        "Veterinary طب بيطري",
    ),
    // Additional products
    (
