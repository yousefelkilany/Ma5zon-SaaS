...
export function Navbar() {
  ...
  return (
    <header className="flex items-center h-20 px-gutter bg-surface-container-low border-b border-outline-variant shrink-0">
      {/* Left: Logo */}
      <div className="flex items-center gap-compact-gap">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-label-caps text-[19px] align-sub text-on-surface-variant">
            {t('nav.appTagline')}
          </span>
        </div>
      </div>
